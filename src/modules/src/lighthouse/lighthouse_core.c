...
pulseProcessor_t lighthouseCoreState = {
   .bsGeometry = {
    ...
    // {.valid = true, .origin = {1.062398, -2.563488,  3.112367, }, .mat = {{0.018067, -0.999336, 0.031647, }, {0.76125097, 0.034269, 0.64755201, }, {-0.648206, 0.012392, 0.76136398, }, }},
		{.valid = true, .origin = {1.432998, 0.595044, 1.549549, }, .mat = {{-0.686551, 0.401950, -0.605875, }, {-0.253403, -0.913328, -0.318776, }, {-0.681495, -0.065326, 0.728902, }, }},
		{.valid = true, .origin = {-1.141100, -1.072179, 1.406328, }, .mat = {{0.743093, -0.549714, 0.381612, }, {0.462823, 0.834059, 0.300235, }, {-0.483330, -0.046483, 0.874203, }, }},
